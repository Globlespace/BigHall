        ...
        <section class="full-product">
            <div class="product section-style">
                <div class="product-name">
                    <?php
                        ...
                        $product_type=new \app\Model\product_type();
            ...
            <div class="product-information">
                                ...
                                $product_type->get($product->Pro_Id);
                                    while ($product_type->next()){
                                        ...
                                        <div class="myslider-item">
                                            <a href="<?=HTTP_HOST.'product/'.$product->Pro_uri.'?pro_type='.$product_type->Id?>" class="product-variety <?=$type==$product_type->Id?'selected':''?>">
                ...
                <div class="YouMayAlsoLikeHeading">You May Also Like</div>
                    <div class="myslider">
                        <?php
                            $youmaylikeProducts=new \app\Model\product();
                            ...
                            while($youmaylikeProducts->next()){
                                ...
                                $i2->next();
                                $product_type2=new \app\Model\product_type();
                                ...
                                <div class="myslider-item">
                                    <div class="YouMayAlsoLike">
                                        <img src="<?=$i2->image?>">
                                        <a href="<?=HTTP_HOST."product/".$youmaylikeProducts->Pro_uri?>" class="product-name"><?=$youmaylikeProducts->Pro_name?></a>
