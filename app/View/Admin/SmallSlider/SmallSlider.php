...
<div class="admin-category-page">
    ...
    <section class="container table-con mt-3 mb-3">
        ...
        <div  class="table">
            ...
            <div dataurl="<?=HTTP_HOST?>admin/SmallSlider" id="data-shower" onscroll="getdataBulkOnScroll(this)" class="tbody">
