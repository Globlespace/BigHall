...
<div class="admin-category-page">
    <div class="container">
        <div class="add">
            <h1>FourGrid List</h1>
            <button class="btn btn-outline-primary open-popup">Upload FourGrid</button>
        </div>
    </div>
    <div class="form-container">
        <form id="submit"  class="addForm" action="<?=HTTP_HOST?>admin/FourGrid" method="post">
            <input id="endpoint" type="hidden" value="0">
            <input id="id" name="id" class="j_Field" type="hidden" value="0">
            <div class="row close-popup" >
                <h3>Upload FourGrid</h3>
                <div class="close">×</div>
            </div>
            <div class="row mt-2" >
                <input id="name" required name="Name" class="j_Field form-field" type="text" placeholder="Enter FourGrid name">
            </div>
            <div class="row mt-2">
            ...
            <div class="row mt-2">
                ...
                <select id="Pro_id_4" required name="Pro_id_4" class="j_Field form-field " >
                    <option value="">Select Pro 4</option>
                    <?php
                    $CatModel=new \app\Model\Products\Product();
                    $CatModel->get();
                    while ($CatModel->next()){
            ...
            <div class="row mt-2">
                <select id="Catid" required name="Catid" class="j_Field form-field mr-1" >
    ...
    <section class="container table-con mt-3 mb-3">
        ...
        <div  class="table">
            ...
            <div dataurl="<?=HTTP_HOST?>admin/FourGrid" id="data-shower" onscroll="getdataBulkOnScroll(this)" class="tbody">
